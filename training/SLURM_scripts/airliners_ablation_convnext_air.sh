#!/bin/bash
#SBATCH --job-name=airliner_ablation_convnext_air         # Name of your job
...
echo "Starting ConvNeXt Single Airline training job..."
python ./main.py \
    --mode train \
    --model single_airline_convnext \
    --epochs 20 \
    --batch_size 64 \
    --lr 0.0001 \
    --checkpoint_freq 10 \
    --checkpoint_dir "./checkpoints/ablation/single_airline_convnext_bs64_lr0.0001" \
    --image_size 224 \
    --num_workers 8 
