#!/bin/bash
#SBATCH --job-name=airliner_ablation_baseline_var         # Name of your job
...
echo "Starting Baseline Variant training job..."
python ./main.py \
    --mode train \
    ...
    --lr 0.001 \
    --checkpoint_freq 10 \
    --checkpoint_dir "./checkpoints/baseline/baseline_variant_bs64_lr0.001" \
    --image_size 300 \
    --num_workers 8 
    
echo "Baseline Variant Training complete!"
