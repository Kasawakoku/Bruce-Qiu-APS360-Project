#!/bin/bash
#SBATCH --job-name=airliner_ablation_baseline_air         # Name of your job
...
echo "Starting Baseline Airline training job..."
python ./main.py \
    --mode train \
    --model baseline_airline \
    --epochs 40 \
    --batch_size 64 \
    --lr 0.001 \
    --checkpoint_freq 10 \
    --checkpoint_dir "./checkpoints/baseline/baseline_airline_bs64_lr0.001" \
    --image_size 300 \
    --num_workers 8 
    
echo "Baseline Airline Training complete!"
