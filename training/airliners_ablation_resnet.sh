#!/bin/bash
#SBATCH --job-name=airliner_ablation_resnet         # Name of your job
...
echo "Starting ResNet training job..."
python ./main.py \
    --mode train \
    --model primary_resnet \
    --epochs 20 \
    --batch_size 64 \
    --lr 0.001 \
    --checkpoint_freq 10 \
    --checkpoint_dir "./checkpoints/ablation/primary_resnet_bs64_lr0.001" \
    --image_size 224 \
    --num_workers 8 
